export default function ErpSaleReportPage() {
  return (
    <div className="flex h-[calc(100vh-theme(spacing.24))] flex-col gap-4">
      <h1 className="font-headline text-3xl font-semibold tracking-tight">Compare Price Report</h1>
      <p className="text-muted-foreground">Sales report with price comparison</p>
