...
export default function ShopifyApiError() {
    return (
        <Alert variant="destructive">
            ...
            <AlertTitle>Connection to Shopify Failed (401 Unauthorized)</AlertTitle>
            <AlertDescription>
                <div className="space-y-4">
                    ...
                    <ol className="list-decimal list-inside space-y-2 text-sm">
                        ...
                        <li>
                            <strong>Check API Scopes:</strong> On the same credentials page, make sure your app has the <strong className="font-mono bg-destructive-foreground/20 px-1 py-0.5 rounded-sm">read_products</strong> permission scope. If not, you must add it under the "Configuration" tab and reinstall the app to get a new token with the correct permissions.
                        </li>
                    </ol>
